        ...
        id='work' className='w-full px-[12%] py-10 scroll-mt-20 '>
            ...
            className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
                {workData.map((project, index) => (
                   ...
                   key={index} 
                   style={{ backgroundImage: `url(${project.bgImage.startsWith('/') ? project.bgImage : `/${project.bgImage}`})` }}
                 ...
                 >
                        ...
                        group-hover:bottom-7 '>
                            ...
                            <motion.div className='border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] 
            ...
            href="" className='w-max flex items-center justify-center gap-2 text-gray-500 border-[0.5px] border-gray-700 rounded-full 
            y-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>Show More 
