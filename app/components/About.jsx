      ...
      >
        ...
        >
          ...
          <p className="mb-10 max-w-2xl font-Ovo">
            I’m a curious and results-driven Full Stack Developer who loves
            turning complex challenges into elegant solutions. From designing
            dynamic interfaces with React and Tailwind CSS to building reliable
            APIs in Laravel and Spring Boot, I bridge the gap between frontend
            creativity and backend engineering. My experience with AWS and CI/CD
            automation helps me deliver fast, scalable, and cloud-ready
            applications.
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
