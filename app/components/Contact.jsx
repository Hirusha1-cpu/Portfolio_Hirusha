...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        {" "}
        I’m always open to discussing new projects, collaborations, or tech
        opportunities. Reach out anytime — call or WhatsApp me at{" "}
        <strong>077 537 1591</strong> or email me at
        <strong> hirushafernando121@gmail.com</strong>. Let’s build something
        amazing together!
      </motion.p>
      <motion.form
        initial={{ opacity: 0 }}
