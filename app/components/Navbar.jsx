...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center bg-white 
                z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20":""}`}> 
                <a href="#top">
                    <Image src={isDarkMode? assets.logo_dark : assets.hirusha_logo} className='w-28 cursor-pointer mr-14' alt='' />
                </a>
                ...
                <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64
                 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-300 dark:bg-darkHover dark:text-white'>
